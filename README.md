...
最近比较优先，先回头再看一下Hadoop源码，准备着重阅读一下HDFS内部的实现，突然发现以前熟读的hadoop ipc又有点模糊了，为了加深记忆，还是在这里重新梳理一下，针对大体思路上做一下笔记，hadoop ipc源码分析类的文章好难写，代码量太大了，只能扣一下比较重要的细节解释一下，具体的还是要自己去阅读代码！！！！
